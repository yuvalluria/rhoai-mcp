"""MCP tools for prompt evaluation and optimization via NeuralNav/Opik backend."""
...
def register_tools(mcp: FastMCP, server: "RHOAIServer") -> None:
    """Register prompt evaluation and optimization tools with the MCP server."""
    ...
    def run_prompt_evaluation(
        ...
        Calls the NeuralNav/Opik backend to score the prompt. For Q&A datasets, set
    ...
    def run_prompt_optimization(
        ...
        """Optimize a system prompt using Opik MetaPrompt (tone, length, audience).

        Calls the NeuralNav/Opik backend. Optional questions_answers can bias the optimization
        (e.g. tone, response_length, domain). Requires opik[optimization] on the backend.
